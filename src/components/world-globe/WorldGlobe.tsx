  ...
  return (
    ...
    >
      <div className="pointer-events-none relative flex h-1 w-1 flex-col items-center">
        ...
        <div
          className={cn(
            'absolute h-1 w-2 animate-ping rounded-full bg-[#3cb878] transition-opacity duration-500',
            isActive ? 'opacity-100' : 'opacity-0'
          )}
        />
        <div className="h-1 w-2 rounded-full bg-[#3cb878] shadow-[0_0_8px_#f97316]" />
        {/* Floating Popup */}
        <div
          className={cn(
        ...
        >
          <h6 className="mb-0.5 whitespace-nowrap text-[6px] font-bold uppercase text-[#3cb878] lg:text-[10px]">
            {country}
          </h6>
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          // Only the center 35% radius is interactive
          touchAction: 'none',
        }}
      >
        <Canvas
